...
export const FAQBlock = ({ title, faqs }: { title?: string; faqs?: FAQ[] }) => {
            ...
            <div className="mx-auto w-full max-w-container px-4 md:px-8 py-24">
                <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-16">
                    <div>
                        ...
                        <h2 className="mt-2 text-display-sm font-semibold text-white md:text-display-md">{title ?? "FAQs"}</h2>
                            ...
                            {items.slice(0, 8).map((item, i) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {isOpen && <p className="mt-3 text-left text-white/75">{item.a}</p>}
                                    </li>
                                );
                            })}
                        </ul>
